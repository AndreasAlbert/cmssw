...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        puppi_tau1 = Var("userFloat('NjettinessAK8Puppi:tau1')",float,doc="",precision=10),
        puppi_tau2 = Var("userFloat('NjettinessAK8Puppi:tau2')",float,doc="",precision=10),
        puppi_tau3 = Var("userFloat('NjettinessAK8Puppi:tau3')",float,doc="",precision=10),
        puppi_tau4 = Var("userFloat('NjettinessAK8Puppi:tau4')",float,doc="",precision=10),
        chs_tau1 = Var("userFloat('ak8PFJetsCHSValueMap:NjettinessAK8CHSTau1')",float,doc="",precision=10),
        chs_tau2 = Var("userFloat('ak8PFJetsCHSValueMap:NjettinessAK8CHSTau2')",float,doc="",precision=10),
        chs_tau3 = Var("userFloat('ak8PFJetsCHSValueMap:NjettinessAK8CHSTau3')",float,doc="",precision=10),
        chs_tau4 = Var("userFloat('ak8PFJetsCHSValueMap:NjettinessAK8CHSTau4')",float,doc="",precision=10),
        chs_pruned_mass = Var("userFloat('ak8PFJetsCHSValueMap:ak8PFJetsCHSPrunedMass')",float,doc="",precision=10),
        chs_softdrop_mass = Var("userFloat('ak8PFJetsCHSValueMap:ak8PFJetsCHSSoftDropMass')",float,doc="",precision=10),
        chs_eta = Var("userFloat('ak8PFJetsCHSValueMap:eta')",float,doc="",precision=10),
        chs_mass = Var("userFloat('ak8PFJetsCHSValueMap:mass')",float,doc="",precision=10),
        chs_phi = Var("userFloat('ak8PFJetsCHSValueMap:phi')",float,doc="",precision=10),
        chs_pt = Var("userFloat('ak8PFJetsCHSValueMap:pt')",float,doc="",precision=10),
        puppi_mass_sd = Var("userFloat('ak8PFJetsPuppiSoftDropMass')",float,doc="",precision=10),
        puppi_nb1_N2 = Var("userFloat('ak8PFJetsPuppiSoftDropValueMap:nb1AK8PuppiSoftDropN2')",float,doc="",precision=10),
        puppi_nb1_N3 = Var("userFloat('ak8PFJetsPuppiSoftDropValueMap:nb1AK8PuppiSoftDropN3')",float,doc="",precision=10),
        puppi_nb2_N2 = Var("userFloat('ak8PFJetsPuppiSoftDropValueMap:nb2AK8PuppiSoftDropN2')",float,doc="",precision=10),
        puppi_nb2_N3 = Var("userFloat('ak8PFJetsPuppiSoftDropValueMap:nb2AK8PuppiSoftDropN3')",float,doc="",precision=10),
        btagCMVA = Var("bDiscriminator('pfCombinedMVAV2BJetTags')",float,doc="CMVA V2 btag discriminator",precision=10),
        btagDeepB = Var("bDiscriminator('pfDeepCSVJetTags:probb')+bDiscriminator('pfDeepCSVJetTags:probbb')",float,doc="DeepCSV b+bb tag discriminator",precision=10),
        btagCSVV2 = Var("bDiscriminator('pfCombinedInclusiveSecondaryVertexV2BJetTags')",float,doc=" pfCombinedInclusiveSecondaryVertexV2 b-tag discriminator (aka CSVV2)",precision=10),
